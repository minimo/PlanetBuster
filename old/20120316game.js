...
//敵弾種類
var BULLET_SMALL = 0;
var BULLET_MEDIUM = 1;		//NORMAL
var BULLET_MEDIUM_R = 2;	//RED
var BULLET_MEDIUM_G = 3;	//GREEN
var BULLET_MEDIUM_B = 4;	//BLUE
var BULLET_LARGE   = 5;
...
window.onload = function() {
	...
	game.preload(
		...
		'media/enemy5_1.png', 'media/enemy5_2.png', 'media/enemy6_1.png', 'media/enemy6_2.png',	'media/missile.png',
...
//		stage = new CanvasGroup();
		...
		stage.bombTime = 0;			//ボム効果持続フレーム数
		stage.bombTimeMax = 60;		//ボム効果持続最大フレーム数
...
/////////////////////////////////////////////////////////////////////////////
		...
		dspBomb.count = new Array(stage.bombMax);
		for( var i = 0; i < stage.bombMax; i++ ){
		...
		dspGroup.addChild( advanceLabel );
...
/////////////////////////////////////////////////////////////////////////////
		...
		var enterItem = function( type, x, y ){
			if( parent == null )return null;
			var obj = enterEnemy( type, x, y, delay );
			if( obj ){
			...
			for( var i = 0; i < numBullets; i++ ){
				if( !bullets[i].using ){
					...
					if( type == BULLET_LARGE || type == BULLET_LARGE_R || type == BULLET_LARGE_G || type == BULLET_LARGE_B ){
						bullets[i].scaleX = 1.25;
						bullets[i].scaleY = 1.25;
...
/////////////////////////////////////////////////////////////////////////////
		...
		var enterBomb = function( x, y ){
			...
			if( stage.bombTime > 0 )return;
//			if( player.muteki > 0 )return;
			stage.bomb--;
			stage.nobomb = false;
			stage.bombTime = ~~(stage.bombTimeMax/spd);
			dspBomb.reflesh();
			player.muteki += 10;
