...
//					game.rootScene.backgroundColor = "#0D2830";
				...
				if( this.time > 180 && this.time % 30 == 0 ){
					var dice = rand(6);
					switch( dice ){
						case 0:
...
//						enterNWayBullet( this, BULLET_MEDIUM1, this.x+24, this.y+60, this.x+24, this.y+100 , 20, 4, 2, 0 );
				...
				if( this.pattern == 2 && this.cycle == 0 && this.time-this.time2 > 90 ){
					...
					if( this.time % 5 == 0 ){
						enterNWayBullet( this, BULLET_MEDIUM1, this.x+  7, this.y+47, this.tx, this.ty, 20, 4, 5, 0 );
						enterNWayBullet( this, BULLET_MEDIUM1, this.x+145, this.y+47, this.tx, this.ty, 20, 4, 5, 0 );
						enterNWayBullet( this, BULLET_MEDIUM1, this.x+ 76, this.y+40, this.tx, this.ty, 20, 4, 5, 0 );
						this.rad2+=1;
					}
					if( this.rad2 > 5 ){
						this.pattern--;
