...
//					enterBullet( this, BULLET_SMALL, this.x + 96, this.y + 20,  1, 3, 0 );
			...
			'SkyBox':function(){
				...
				if( this.time % 60 == 0 ){
					enterNWayBullet( this, BULLET_MEDIUM1, this.x+16, this.y+20, this.x+16, this.y+100, 20, 3, 3, 0 );
					enterNWayBullet( this, BULLET_MEDIUM1, this.x+80, this.y+20, this.x+80, this.y+100, 20, 3, 3, 0 );
				}
				switch( this.pattern ){
					case 0:
